...
- **Token 估算校准** — 基于 DeepSeek-V3 BPE 分词器校准，公式为 `chars × 0.25`；列表每条记忆卡片显示预估 token 数，方便评估注入成本
...
默认 Token 预算为 3000（可在设置页面调整 500~10000），Token 估算基于 DeepSeek-V3 BPE 分词器校准（公式 `chars × 0.25`）。
